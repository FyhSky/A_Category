...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/FyhSky/A_Category.git"
  ...
  s.source       = { :git => "https://github.com/FyhSky/A_Category.git", :tag => s.version.to_s }
  ...
  #
   #s.source_files = "A_Category/A_Category/Source/*.{h,m}"

   s.source_files  = "A_Category/Source/**/*.{h,m}"
